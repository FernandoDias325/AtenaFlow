...
* **Motivo da alteração:** Manter a Janela Dedicada limpa e sem *sidebars* exageradas, utilizando um padrão de "chips" horizontais que economizam espaço vertical e lateral.
* **Testes realizados:**
...
* **Motivo da alteração:** Prover um método manual de sincronização e backup seguro sem depender da infraestrutura de nuvem, facilitando o compartilhamento entre times. A estratégia *Upsert* protege dados locais existentes.
* **Testes realizados:**
